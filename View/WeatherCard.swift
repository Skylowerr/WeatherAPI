...
//  WeatherAppAPI
//
//  Created by Emirhan Gökçe on 15.10.2025.
//
...
struct WeatherCard: View {
    ...
    //APIdaki veri değişken olduğu için COMPUTED PROPERTY olacak
    ...
    var body: some View {
        VStack{
            AsyncImage(url: URL(string: urlString)) { image in
                ...
                ProgressView()
                // İkon yüklenene kadar dönen bir ProgressView gösteriyor.
            }
